  ...
  experience: [
    {
      ...
      summary:
        "Boutique e-commerce de mode en ligne proposant des vêtements tendance avec gestion complète des produits, marketing digital et expérience utilisateur.",
      highlights: [
        "Conçu et développé une plateforme e-commerce complète dédiée aux vêtements tendance, incluant un catalogue multi-niveaux avec gestion des catégories, promotions, stock, et statuts produits.",
      ...
      images: [
        { src: "/ExpPro/Marvella/2 (1).png", alt: "Marvella interface 1" },
        { src: "/ExpPro/Marvella/2 (2).png", alt: "Marvella interface 2" },
        { src: "/ExpPro/Marvella/2(3).jpg", alt: "Marvella interface 3" },
        { src: "/ExpPro/Marvella/2(4).jpg", alt: "Marvella interface 4" },
        { src: "/ExpPro/Marvella/2(5).jpg", alt: "Marvella interface 5" },
        { src: "/ExpPro/Marvella/2(6).jpg", alt: "Marvella interface 6" },
        { src: "/ExpPro/Marvella/1.png", alt: "Marvella interface 7" },
        { src: "/ExpPro/Marvella/3.jpg", alt: "Marvella interface 8" },
        { src: "/ExpPro/Marvella/4.jpg", alt: "Marvella interface 9" },
        { src: "/ExpPro/Marvella/5.jpg", alt: "Marvella interface 10" },
        { src: "/ExpPro/Marvella/6.jpg", alt: "Marvella interface 11" },
        { src: "/ExpPro/Marvella/7.jpg", alt: "Marvella interface 12" },
        { src: "/ExpPro/Marvella/8.png", alt: "Marvella interface 13" },
        { src: "/ExpPro/Marvella/9.jpg", alt: "Marvella interface 14" },
        { src: "/ExpPro/Marvella/10.jpg", alt: "Marvella interface 15" },
        { src: "/ExpPro/Marvella/11.jpg", alt: "Marvella interface 16" },
        { src: "/ExpPro/Marvella/12.jpg", alt: "Marvella interface 17" },
        { src: "/ExpPro/Marvella/13.jpg", alt: "Marvella interface 18" },
        { src: "/ExpPro/Marvella/14.jpg", alt: "Marvella interface 19" },
      ],
      mobileImages: [
        { src: "/ExpPro/Marvella/versionmobile/15.jpg", alt: "Marvella mobile 1" },
        { src: "/ExpPro/Marvella/versionmobile/16.jpg", alt: "Marvella mobile 2" },
        { src: "/ExpPro/Marvella/versionmobile/17.jpg", alt: "Marvella mobile 3" },
        { src: "/ExpPro/Marvella/versionmobile/18.jpg", alt: "Marvella mobile 4" },
        { src: "/ExpPro/Marvella/versionmobile/19.jpg", alt: "Marvella mobile 5" },
        { src: "/ExpPro/Marvella/versionmobile/20.jpg", alt: "Marvella mobile 6" },
        { src: "/ExpPro/Marvella/versionmobile/21.jpg", alt: "Marvella mobile 7" },
        { src: "/ExpPro/Marvella/versionmobile/22.jpg", alt: "Marvella mobile 8" },
        { src: "/ExpPro/Marvella/versionmobile/23.jpg", alt: "Marvella mobile 9" },
        { src: "/ExpPro/Marvella/versionmobile/24.jpg", alt: "Marvella mobile 10" },
        { src: "/ExpPro/Marvella/versionmobile/25.jpg", alt: "Marvella mobile 11" },
        { src: "/ExpPro/Marvella/versionmobile/26.jpg", alt: "Marvella mobile 12" },
        { src: "/ExpPro/Marvella/versionmobile/27.jpg", alt: "Marvella mobile 13" },
      ],
    },
    {
      title: "Développeur Full Stack",
